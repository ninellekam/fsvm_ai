...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative scroll-smooth">
      ...
      <nav className="sticky top-0 z-40">
        <div className="mx-auto max-w-7xl px-0 sm:px-4 md:px-8">
  ...
  >
    ...
    {/* Ваш контент */}
    <div className="relative z-10 mx-auto max-w-7xl h-full px-0 sm:px-4 md:px-8">
            <div className="flex h-full items-end md:items-center">
              <div className="pb-10 md:pb-0 max-w-3xl">
                ...
                <p className="mt-4 text-white/80 text-base md:text-lg max-w-2xl">
                  ...
                  Экономьте время и деньги: не нужны фотосессии, студии и модели — всё происходит онлайн за минуты.<br /> <br />
...
>
  <div className="mx-auto max-w-7xl px-0 sm:px-4 md:px-8 grid md:grid-cols-2 gap-10 items-start">
  ...
  <div class="blob blob3"></div>
    ...
    <Card className="border-white/10 bg-black/40 backdrop-blur-xl overflow-hidden">
      ...
      <section id="faq" className="py-16 md:py-20">
        <div className="mx-auto max-w-3xl px-0 sm:px-4 md:px-8">
          <h2 className="text-2xl md:text-3xl font-bold text-center tracking-tight">
            FAQ
          </h2>
      ...
      <footer className="py-10">
        <div className="mx-auto max-w-7xl px-0 sm:px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/70">
          <div className="flex items-center gap-3">
